...
- `/src/app/globa.css` 업데이트
- 반드시 `@import 는 css 첫 줄`이여야 함.
...
- 플로그인(확장 프로그램) `Prettier - Code formatter 설치` 필요
...
- `/.vscode/extenstions.json` 확장 프로그램 정의 내용 작성
