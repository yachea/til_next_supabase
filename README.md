...
- `/src/compnnents/post 폴더` 생성
- `/src/compnnents/post/CreatePostButton.tsx 파일` 생성
...
### 5.2. PostEditorModal 컴포넌트를 화면에 랜더링하기
...
- `/src/compnnents/post/CreatePostButton.tsx 파일` 업데이트
...
- `/src/components/modal/PostEditorModal.tsx` 업데이트(close추가)
